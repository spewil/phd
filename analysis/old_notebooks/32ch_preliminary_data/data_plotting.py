...
plt.style.use('default_print.mplstyle')
...
def plot_preprocessing_steps(signal, ax=None):
    ...
    ax.plot(analysis.rectify(analysis.highpass(signal, cutoff=55)),
            label="HP + R")
    pp = analysis.lowpass(analysis.rectify(analysis.highpass(signal,
                                                             cutoff=60)),
                          cutoff=3)
