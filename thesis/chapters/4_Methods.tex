...
\begin{figure}
  ...
  \begin{minipage}{0.33\textwidth}
    ...
    \subcaption{}
  \end{minipage}
  \caption{(a)  (b)  (c)  (d)}\label[figure]{final_setup}
\end{figure}
