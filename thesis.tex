...
Environments</h1>
      ...
      <div class="main-col">
          <div class="main">
            ...
            \%
            \textless\textless{[}sections/problem\_formalization.md{]}

            \% \textless\textless{[}sections/data\_analysis.md{]}

            \% \textless\textless{[}sections/theory.md{]}

            \% \textless\textless{[}sections/next\_steps.md{]}
