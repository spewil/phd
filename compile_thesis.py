...
# pandoc-include to transclude markdown files - https://github.com/DCsunset/pandoc-include
...
def compile_to_latex():
    ...
    pypandoc.convert_file(
        source_file="thesis_pdf.md",
        format="md",
        to="tex",
        outputfile="thesis.tex",  # put the text next to the md input
...
def compile_to_pdf():
    ...
    os.system("cd build/latex/output; latexmk -pdf ../thesis.tex")
    os.chdir(root_folder)
...
def compile_to_docx():
    ...
    pypandoc.convert_file(
        source_file="build/docx/thesis_docx.md",
        format="md",
        to="docx",
...
def compile_to_html():
    ...
    pypandoc.convert_file(
        source_file="build/html/thesis.md",
        to="html5",
